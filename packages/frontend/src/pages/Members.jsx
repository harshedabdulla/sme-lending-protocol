    ...
    <div className="card-hover">
      <div className="flex items-start justify-between mb-4">
        <div className="space-y-1">
          <div className="text-xs text-gray-600 dark:text-gray-500 font-mono">Proposal #{proposalId}</div>
      ...
      <div className="mb-4">
        ...
        <p className="text-sm text-gray-600 dark:text-gray-500">{proposal.reason}</p>
      </div>

      <div className="space-y-3 mb-4">
        <div>
          <div className="flex items-center justify-between mb-1">
            <span className="text-xs text-gray-600 dark:text-gray-500">For</span>
            <span className="text-xs text-emerald-600 dark:text-emerald-400 font-mono">{forPercentage.toFixed(1)}%</span>
          </div>
        ...
        <div>
          <div className="flex items-center justify-between mb-1">
            <span className="text-xs text-gray-600 dark:text-gray-500">Against</span>
            <span className="text-xs text-red-600 dark:text-red-400 font-mono">{againstPercentage.toFixed(1)}%</span>
          </div>
          <div className="h-1.5 bg-gray-200 dark:bg-gray-900 rounded-full overflow-hidden">
            <div
      ...
      {canExecute && (
        <div className="space-y-3">
          <div className="card bg-blue-100/50 dark:bg-blue-950/20 border border-blue-200 dark:border-blue-900/30">
      ...
      {proposal.executed && (
        <div className="text-center p-3 rounded-lg bg-gray-100 dark:bg-zinc-950/30 border border-gray-200 dark:border-gray-900">
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="space-y-2">
        <h1 className="text-3xl font-semibold text-gray-900 dark:text-gray-100">Members</h1>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        <div className="stat-card hover:border-gray-300 dark:hover:border-gray-800">
          <div className="flex items-center justify-between">
            ...
            <Users className="w-4 h-4 text-gray-500 dark:text-gray-600" />
          </div>
        ...
        <div className="stat-card hover:border-gray-300 dark:hover:border-gray-800">
          <div className="flex items-center justify-between">
            ...
            <Vote className="w-4 h-4 text-gray-500 dark:text-gray-600" />
          </div>
        ...
        <div className="stat-card hover:border-gray-300 dark:hover:border-gray-800">
          <div className="flex items-center justify-between">
            ...
            <UserPlus className="w-4 h-4 text-gray-500 dark:text-gray-600" />
          </div>
        ...
        <div className="card border-blue-900/20 bg-blue-100/50 dark:bg-blue-950/10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="text-center p-4 bg-gray-100 dark:bg-gray-900/50 rounded-lg">
              <div className="text-2xl font-semibold text-gray-900 dark:text-gray-100">{crossChainStats.totalVotes ?? 0}</div>
              <div className="text-xs text-gray-600 dark:text-gray-500 mt-1">Total Cross-Chain Votes</div>
            </div>
            <div className="text-center p-4 bg-gray-100 dark:bg-gray-900/50 rounded-lg">
              <div className="text-2xl font-semibold text-gray-900 dark:text-gray-100">{crossChainStats.crossChainProposals ?? 0}</div>
              <div className="text-xs text-gray-600 dark:text-gray-500 mt-1">Cross-Chain Proposals</div>
            </div>
            <div className="text-center p-4 bg-gray-100 dark:bg-gray-900/50 rounded-lg">
              <div className="text-2xl font-semibold text-gray-900 dark:text-gray-100">{crossChainStats.activeGovernance ?? 0}</div>
        ...
        <div>
          {!isConnected ? (
            <div className="card text-center py-12">
              <Vote className="w-12 h-12 text-gray-600 dark:text-gray-700 mx-auto mb-4" />
            ...
            <div className="card text-center py-12">
              <Vote className="w-12 h-12 text-gray-600 dark:text-gray-700 mx-auto mb-4" />
              <p className="text-sm text-gray-600 dark:text-gray-400 mb-2">No membership proposals yet</p>
              <p className="text-xs text-gray-600 dark:text-gray-500">Be the first to propose a new member</p>
            </div>
          ) : (
      ...
      {activeTab === 'members' && (
        <div className="card text-center py-12">
          <Users className="w-12 h-12 text-gray-600 dark:text-gray-700 mx-auto mb-4" />
          <p className="text-sm text-gray-600 dark:text-gray-400 mb-2">{memberCount} Active Members</p>
          <p className="text-xs text-gray-600 dark:text-gray-500">Member directory coming soon</p>
        </div>
      )}
      ...
      {activeTab === 'propose' && (
        <div className="max-w-2xl">
          <div className="card-bordered">
            <h2 className="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-6">Propose New Member</h2>

            <div className="space-y-5">
              <div>
                <label className="block text-sm font-medium text-gray-700 dark:text-gray-400 mb-2">Candidate Address</label>
                <input
                  type="text"
              ...
              <div>
                <label className="block text-sm font-medium text-gray-700 dark:text-gray-400 mb-2">Reason for Membership</label>
                <textarea
                  value={reason}
                ...
                />
                <p className="text-xs text-gray-600 dark:text-gray-500 mt-2">Provide a clear reason for the membership proposal</p>
              </div>

              <div className="card bg-gray-100 dark:bg-zinc-950/30">
                <h3 className="text-sm font-medium text-gray-700 dark:text-gray-300 mb-3">Voting Requirements</h3>
                <ul className="space-y-2 text-xs text-gray-600 dark:text-gray-400">
                  <li className="flex items-start space-x-2"><span className="text-blue-600 dark:text-blue-400">•</span>2/3 majority (66.67%) required for approval</li>
                  <li className="flex items-start space-x-2"><span className="text-blue-600 dark:text-blue-400">•</span>7-day voting period</li>
                  <li className="flex items-start space-x-2"><span className="text-blue-600 dark:text-blue-400">•</span>Must stake governance tokens to vote</li>
                  <li className="flex items-start space-x-2"><span className="text-blue-600 dark:text-blue-400">•</span>Approved members receive Reputation NFT</li>
                </ul>
              </div>
              ...
              {hash && (
                <div className="text-center space-y-2">
                  {isConfirming && <p className="text-sm text-amber-700 dark:text-amber-400">Transaction submitted, waiting for confirmation...</p>}
                  {isConfirmed && <p className="text-sm text-emerald-700 dark:text-emerald-400">Proposal created successfully! Check the Proposals tab.</p>}
                  <p className="text-xs text-gray-600 dark:text-gray-500 font-mono">
                    <a href={`https://sepolia.etherscan.io/tx/${hash}`} target="_blank" rel="noopener noreferrer" className="hover:text-blue-600 dark:hover:text-blue-400">
                      View on Etherscan ↗
                    </a>
                  </p>
                </div>
              ...
              {error && <p className="text-sm text-center text-red-700 dark:text-red-400">Error: {error.message}</p>}
              {!isConnected && <p className="text-sm text-center text-gray-600 dark:text-gray-500">Connect wallet to propose a new member</p>}
            </div>
          </div>
        </div>
      )}
