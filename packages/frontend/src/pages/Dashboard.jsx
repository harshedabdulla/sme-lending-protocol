...
const StatCard = ({ label, value, icon: Icon, loading }) => (
  <div className="stat-card hover:border-gray-300 dark:hover:border-gray-800 group">
    <div className="flex items-center justify-between">
      <span className="stat-label">{label}</span>
      <Icon className="w-4 h-4 text-gray-500 dark:text-gray-600 group-hover:text-gray-600 dark:group-hover:text-gray-500 transition-colors" />
    </div>
            ...
            <div className="flex items-start space-x-3 flex-1">
              ...
              <div>
                ...
                <div className="text-sm text-gray-700 dark:text-gray-400 space-y-1">
                  ...
                  <ol className="list-decimal list-inside space-y-1 text-xs text-gray-600 dark:text-gray-400 mt-2 ml-2">
